...
public class VlcVideoActivity extends Activity implements SurfaceHolder.Callback, IVideoPlayer {
	...
	private static String MRL = "rtsp://192.168.18.157:554/stream0/high";
	private static String MRL_2 = "rtsp://192.168.18.221:554/user=admin&password=&channel=1&stream=0.sdp?real_stream--rtp-caching=100";
	private static String MRL_3 = "rtsp://192.168.18.136:8554/";
	private static String testMRL = "rtsp://192.168.18.20:8554/1";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//mMediaPlayer.playMRL("http://211.153.74.60/DSApp/statics/upload/2015/3/14266717103505249.mp4");
		mMediaPlayer.playMRL(testMRL);
		//mMediaPlayer.playMRL(MRL_2);
	}
